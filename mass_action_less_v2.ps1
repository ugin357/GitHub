...
Write-Host "Включилась" -ForegroundColor Green
}
else { 
...
Write-Host = "Отправляю выключать!" -ForegroundColor Red
PowerOffVM $VM 
...
Get-VM $VM | Select-Object Name,PowerState,NumCpu,MemoryGB,Folder,CreateDate,Id,ProvisionedSpaceGB,UsedSpaceGB 
}
